...
import UzPhoneField from "@/pages/users/components/UzPhoneField.tsx";
                    ...
                    <form onSubmit={handleCreateUser} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className={[
                                        "w-full px-4 py-3 rounded-xl border text-base transition",
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            ...
                            <div className="flex flex-col justify-end">
                                <ToggleSwitch
                                    id="create_profile_edit_blocked"
                                    isDark={isDark}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <ToggleSwitch
                                    id="create_deactivation_toggle"
                                    isDark={isDark}
                                    checked={deactivationEnabled}
                                    onChange={(enabled) => {
                                        if (enabled) {
                                            // If enabling and no date set, seed with now (user can adjust)
                                            ...
                                            // Disabling clears both date and days
                                            setCreateForm({
                                                ...createForm,
                                                profile: {
                                                    ...createForm.profile,
