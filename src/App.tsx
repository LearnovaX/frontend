...
function ThemeAwareLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (actualTheme) document.body.classList.add(actualTheme);
    return () => {
      if (actualTheme) document.body.classList.remove(actualTheme);
    };
  }, [actualTheme]);
            ...
            <Routes>
              ...
              >
                ...
                <Route
                  ...
                  element={<Navigate to="/checking" replace />}
                />
                <Route
                  path="/checking/:studentId/review/:courseId"
                  element={<StudentReview />}
                />
                <Route
                  path="/teacher/students/:studentId/review/:courseId"
                  element={<StudentReview />}
                />
                <Route path="/plagiarism" element={<PlagiarismDashboard />} />
                <Route
                  path="/plagiarism/reports/:id"
                  element={<PlagiarismReportDetail />}
                />
                <Route path="/chat" element={<ChatPage />} />
